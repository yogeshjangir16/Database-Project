<?php
    ...
    function get_user_issue_book_count(){
        ...
        $query = "select count(*) as user_issue_book_count from issue_books where student_id = $_SESSION[student_id]";
...
<body>
    ...
    <div class="row">
        <div class="col-md-3" style="margin-left: 50px; margin-top: 125px;">
            <div class="card bg-light" style="width: 300px">
                <div class="card-header">Book Issued</div>
                <div class="card-body">
                    <p class="card-text">No of book issued: <?php echo get_user_issue_book_count();?></p>
                    <a class="btn btn-success" href="issue_books.php">View Issued Books</a>
                </div>
            </div>
        </div>
