                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_assoc($query_run)){
                            ...
                            <tr>
                                ...
                                <td><button class="btn" style="background-color: #e3f2fd; height: 50px; align-items: center;"><a href="author_edit.php?aid=<?php echo $row['author_id'];?>">Edit</a></button>
                                <button class="btn" style="background-color: #e3f2fd; height: 50px; align-items: center;"><a href="author_delete.php?aid=<?php echo $row['author_id'];?>">Delete</a></button></td>
                            </tr>
                            <?php
                        }
                    ?>
