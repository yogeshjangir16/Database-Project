        ...
        <div class="col-md-4">
            <form action="" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="author_name" class="form_cotrol" required="">
                </div>
                <div class="form-group">
                    <label>Mobile:</label>
                    <input type="text" name="author_mobile" class="form_cotrol" required="">
                </div>
                <div class="form-group">
                    <label for="name">Address:</label>
                    <textarea rows="3" cols="40"  name="author_address" class="for-control" required></textarea>
                </div>
...
if (isset($_POST['add_author'])) {
    ...
    $existing_query = "SELECT * FROM author WHERE author_name = '$author_name' AND mobile =  '$mobile' AND address =  '$address'  ";
    $result = mysqli_query($connection, $existing_query);

    if (mysqli_num_rows($result) > 0) {
        echo '<script>alert("Author already exists");</script>';
    } else {
        $query = "INSERT INTO author (author_name,mobile,address) VALUES ('$author_name','$mobile','$address')";
