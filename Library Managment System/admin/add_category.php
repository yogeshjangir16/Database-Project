        ...
        <div class="col-md-4">
            <form action="" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="category_name" class="form_cotrol" required="">
                </div>
...
if (isset($_POST['add_category'])) {
    ...
    $book_category = $_POST['category_name'];
    $existing_query = "SELECT * FROM category WHERE category_name = '$book_category'";
    $result = mysqli_query($connection, $existing_query);

    if (mysqli_num_rows($result) > 0) {
        echo '<script>alert("Category already exists");</script>';
    } else {
        $query = "INSERT INTO category (category_name) VALUES ('$book_category')";
