...
<?php
    ...
    $query = "UPDATE books SET book_name = '$book_name', author_id = $author_id, category_id = $cat_id, book_price = $book_price WHERE book_no = $book_no";
    $query_run = mysqli_query($connection, $query);
		$query_run = mysqli_query($connection,$query);

	if ($query_run) {
        echo '<script type="text/javascript">';
            echo 'alert("Book Edited successfully");';
            echo 'window.location.href = "add_manage_book.php";';
            echo '</script>';
    } else {
