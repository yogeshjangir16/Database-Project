<?php
	...
	$book_no = "";
	$student_name = "";
	$query = "select issue_books.book_name,issue_books.author_name,issue_books.book_no,users.name from issue_books left join users on issue_books.student_id = users.student_id where issue_books.status = 1";
?>
