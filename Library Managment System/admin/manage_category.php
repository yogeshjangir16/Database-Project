                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_assoc($query_run)){
                            ...
                            <tr>
                                ...
                                <td><button class="btn" style="background-color: #e3f2fd; height: 50px; align-items: center;"><a href="category_edit.php?cid=<?php echo $row['category_id'];?>">Edit</a></button>
                                <button class="btn" style="background-color: #e3f2fd;height: 50px; align-items: center;"><a href="category_delete.php?cid=<?php echo $row['category_id'];?>">Delete</a></button></td>
                            </tr>
                            <?php
                        }
                    ?>
