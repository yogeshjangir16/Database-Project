    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd; margin-top: 100px;height: 50px; align-items: center;">
        <div class="container-fluid">
            <ul class="nav navbar-nav navbar-center">
                ...
                <li class="nav-item">
                    <a href="view_issue_books.php" class="nav-link">Issue Book</a>
                </li>
            </ul>
        </div>
    </nav>
                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_assoc($query_run)){
                            ...
                            <tr>
                                ...
                                <td><button class="btn" style="background-color: #e3f2fd; height: 50px; align-items: center;"  name=""><a href="edit_book.php?bn=<?php echo $row['book_no'];?>">Edit</a></button>
                                <button class="btn" style="background-color: #e3f2fd; height: 50px; align-items: center;" ><a href="delete_book.php?bn=<?php echo $row['book_no'];?>">Delete</a></button></td>
                            </tr>
                            <?php
                        }
                    ?>
